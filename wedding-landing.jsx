          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  type="submit"
                  className="px-8 py-4 bg-slate-900 hover:bg-slate-800 text-white font-medium rounded-lg transition-all hover:shadow-lg"
                >
                  사전등록
                </button>
              </div>
              <p className="text-sm text-slate-400 mt-4">
                {count.toLocaleString()}명의 예비부부가 함께하고 있습니다
              </p>
            </form>
          ) : (
